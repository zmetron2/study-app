...
API_URL = "https://zmetron-study.pages.dev/api/resources"
...
print("=== Posting Post 1: Phaser this binding ===")
r1 = post_resource(POST_1)
print(json.dumps(r1, ensure_ascii=False, indent=2))

print("\n=== Posting Post 2: Next.js build error ===")
r2 = post_resource(POST_2)
