...
const DEFAULT_RESOURCES: Resource[] = [
  ...
  { id: 17, title: '서버 정보 및 관리 보안 가이드', description: '### 🔐 서버 정보 및 관리자 계정 보안 관리 가이드...', url: '#', category: '문서/가이드', tags: 'Security,DevOps,Admin', provider: 'Vibe', rating: 5.0, icon_text: 'SEC', created_at: '2026-05-05' },
